...
import ru.adorly.adcomposition.data.GameRepositoryImpl
...
import ru.adorly.adcomposition.domain.usecases.GenerateQuestionUseCase
import ru.adorly.adcomposition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun calculatePercentOfRightAnswers(): Int {
        ...
        return (countOfRightAnswers.toDouble() * 100 / countOfQuestions).toInt()
    }
